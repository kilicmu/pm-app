<template>
    <div class="system-role-container layout-padding">
        <h1 style="font-size: 24px; font-weight: bold; padding: 12px 0;">管理项目信息</h1>
        <div class="system-role-padding layout-padding-auto layout-padding-view">
            ...
            <el-table :data="displayTableData" v-loading="loading" style="width: 100%; margin-top: 18px">
                ...
                <el-table-column prop="info" label="项目简介" show-overflow-tooltip></el-table-column>
                <el-table-column prop="price" label="项目价格" show-overflow-tooltip></el-table-column>
...
const refreshTableData = () => {
    loading.value = true
    setTimeout(() => {
        request({ url: '/project/getProjectList' }).then(data => {
...
const onRowDel = (row) => {
    ElMessageBox.confirm(`此操作将永久删除项目，是否继续?`, '提示', {
