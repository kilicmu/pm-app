<template>
    <div class="system-role-container layout-padding">
        <h1 style="font-size: 24px; font-weight: bold; padding: 12px 0;">管理科室信息</h1>
        <div class="system-role-padding layout-padding-auto layout-padding-view">
            <div class="system-user-search mb15">
                <el-input v-model="filterParams.name" size="default" placeholder="请输入科室名" style="max-width: 180px">
                </el-input>
            ...
            <el-table :data="displayTableData" v-loading="loading" style="width: 100%; margin-top: 18px">
                ...
                <el-table-column prop="name" label="科室名" show-overflow-tooltip></el-table-column>
                <el-table-column prop="info" label="科室简介" show-overflow-tooltip></el-table-column>
                <el-table-column prop="status" label="科室状态" show-overflow-tooltip>
                    <template #default="{ row: { status } }">
                        <el-tag type="success" v-if="status === 1">正常</el-tag>
...
const refreshTableData = () => {
    loading.value = true
    setTimeout(() => {
        request({ url: '/department/getDepartmentList' }).then(data => {
...
// 删除角色
const onRowDel = (row) => {
    ElMessageBox.confirm(`此操作将永久删除科室”，是否继续?`, '提示', {
